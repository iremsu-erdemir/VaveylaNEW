...
class _AdminAssignCouponScreenState extends State<AdminAssignCouponScreen> {
  ...
  String _couponLabel(CouponOption c) =>
      '${c.code} - ${c.discountType == 1 ? "%${c.discountValue.toInt()}" : "${c.discountValue.toInt()} ₺"}';

  String _customerLabel(CustomerOption c) => '${c.fullName} (${c.email})';
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    selectedItemBuilder: (context) => _coupons
                        .map(
                          (c) => Align(

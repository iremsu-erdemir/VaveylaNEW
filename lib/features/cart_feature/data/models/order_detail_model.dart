...
class OrderDetailModel {
  ...
  CustomerOrderStatus get orderStatus =>
      CustomerOrderModel.parseStatus(status);

  /// Tekrar Sipariş Ver — yalnızca teslim, iptal ve iade sonrası.
  bool get showReorderButton {
    switch (orderStatus) {
  ...
  bool get isReorderEnabled => showReorderButton && canReorder;

  /// Siparişi İptal Et — yalnızca bekleyen ve hazırlanan siparişlerde.
  ...
  bool get isCancelEnabled => canCancel;

  /// Destek Talebi — onay sonrası (bekleyen hariç).
  bool get showSupportButton =>
      orderStatus != CustomerOrderStatus.pending;

  bool get isSupportEnabled => showSupportButton;

  /// Fatura — yalnızca tamamlanmış veya iade sürecindeki siparişlerde.
  bool get showInvoiceButton {
    switch (orderStatus) {
      case CustomerOrderStatus.completed:
      case CustomerOrderStatus.refundRequested:
        return true;
  ...
  bool get isInvoiceEnabled => showInvoiceButton;
}
